...
class AIService:
    """Advanced AI service with Groq LLM integration"""
    ...
    def __init__(self, api_key: str, model: str = "llama3-70b-8192"):
        ...
        # Query templates for different data operations
        self.query_templates = {
            "filter": "Find records where {field} {operator} {value}",
            "aggregate": "Calculate {function} of {field} grouped by {group_field}",
            "trend": "Show trend of {field} over time period {period}",
            "compare": "Compare {field1} vs {field2} across {dimension}"
        }
        ...
        try:
            ...
            for field in stats["fields"]:
                ...
                if field_values:
                    ...
                    # Unique values (sample for performance)
